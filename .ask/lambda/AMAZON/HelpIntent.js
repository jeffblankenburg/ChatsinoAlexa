...
function HelpIntent(handlerInput) {
    ...
    switch(sessionAttributes.previousAction) {
        ...
        break;
        case "POKERDEAL":
            speakOutput = "You just finished a game of video poker.  Your final hand is compared to our poker paytable to determine if you are a winner. To hear a list of the winning hands, you can say, give me the poker paytable."
        break;
        case "POKERHOLD":
        ...
        break;
        case "STARTSLOTS":
            speakOutput = "Each spin of the slot machine results in three reels spinning.  You are trying to match three of a kind, or a few other specific outcomes.  To hear the list of outcomes, you can say, what is the paytable for slots. ";
        break;
    }
