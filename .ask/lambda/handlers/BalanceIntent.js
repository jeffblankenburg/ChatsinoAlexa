...
async function BalanceIntent(handlerInput) {
    ...
    if (sessionAttributes.user.fields.CurrentWagers > 0) speakOutput += `You also have ${sessionAttributes.user.fields.CurrentWagers} coins actively wagered in some of the games. `;
